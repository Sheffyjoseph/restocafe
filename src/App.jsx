...
const App = () => {
  ...
  return (
    <div className="h-[100vh]">
      <div className="h-[20vh] bg-gray-50 flex flex-col justify-center sticky top-0">
      ...
      <div className="h-[123vh] bg-gray-200">
        <Cards
          dish={data[0]?.table_menu_list[menu]?.category_dishes}
          cart={cart}
          setCart={setCart}
        />
      </div>
